...
for (let i=1; i<photos.length; i++){
    ...
    let [previousTop, previousBottom, previousLeft, previousRight] = get_coordinates(previous)
    let [currentTop, currentBottom, currentLeft, currentRight] = get_coordinates(current)
    if (check_intersect(
        previousTop, previousBottom, previousLeft, previousRight,
...
function check_intersect( // true = intersects, false = does
    RectATop, RectABottom, RectALeft, RectARight,
    RectBTop, RectBBottom, RectBLeft, RectBRight) {
